...
import { AlertCircle, Users, Target, BarChart } from "lucide-react";
...
export function TargetUsers({ data }: Props) {
  if (!data) {
    return renderError("No data provided for Target Users section.");
  }

  if (data.status === "failed" || data.error) {
    return renderError(
      data.error || 
      "Failed to generate Target Users analysis."
    );
  }
