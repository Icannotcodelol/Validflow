...
export function UnitEconomics({ data }: UnitEconomicsProps) {
  console.log('UnitEconomics - Rendering with data:', data);

  // Handle failed or missing data state
  if (data.status === 'failed' || !data.pricing) {
    return (
      <Card>
        <CardHeader>
        ...
        <CardContent>
          <div className="text-muted-foreground">
            {data.error || 'Unit economics data could not be generated. Please try again.'}
          </div>
        </CardContent>
      </Card>
    );
